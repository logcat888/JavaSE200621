 ...
 * @author chenhuiup
 * @create 2020-07-12 上午 9:04
 */
public class StringBufferBuilderTest {
    /*
        对比String、StringBuffer、StirngBuilder三者的效率：
...
//        s1.reverse();
    ...
    StringBuilder：可变的字符序列；jdk5.0新增的，线程不安全，效率高；底层使用char[] 储存
    ...
    //问题2.扩容问题：如果要添加的数据底层数组盛不下了，那就需要扩容底层的数组。
            ...
            指导意义：开发中建议大家使用：StringBuffer(int capacity) 或 StringBuilder(int capacity),指定容量大些，避免使用
                    默认16长度的，以便后续如果出现扩容问题，影响效率。
